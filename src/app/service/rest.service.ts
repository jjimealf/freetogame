...
export class RestService {
  ...
  apiUrl2 = 'https://free-to-play-games-database.p.rapidapi.com/api'
  ...
  listarJuegosPorPlataforma(plataforma: string){
    return new Promise((resolve) => {
      this.http.get<juego>(this.apiUrl2 + '/games?platform='+plataforma,
      {
        headers: new HttpHeaders().set(
          'X-RapidAPI-Key',
          '9038f2620amsh062912a94ec6960p1b7f52jsn07e1954daa31'
